...
export class HomeComponent {
  ...
  `
    ...
    Welcome to the webclient of my Master's Thesis.
    ...
    <img src="https://i.ibb.co/0nyCzNb/System-Context-drawio.png" alt="Trust Coalition System Context" border="0" />
    ...
    ## Architecture
    This domain *optimates.ch* points to a Virtual Private Server that runs a reverse proxy server.
    ...
    <img src="https://i.ibb.co/9bNstvq/architecture-overview-ISSUER-drawio-1.png" alt="architecture-overview-ISSUER-drawio-1" border="0">
    ...
    *[4]* [lifecycle-api](https://github.com/uzhAndy/fed-gov-ddos-data-mesh/tree/main/lifecycle-api)
    ...
    The TCA implements the [*Hyperledger Aries*](https://www.hyperledger.org/projects/aries) framework *Aries Cloud Agent Python* (ACApy) to create connections to other agents, issue and revoke VCs, and verify proofs.
    The corresponding public key material is hosted on the Verifiable Organizations Network (VON).
    It implements the DLT with [*Hyperledger Indy*](https://www.hyperledger.org/projects/hyperledger-indy); the government of British Columbia further offers a mobile application ([android](https://play.google.com/store/apps/details?id=ca.bc.gov.BCWallet), [iOS](https://apps.apple.com/us/app/bc-wallet/id1587380443)) to which you can issue your demo credentials to.
    ...
    | **protected** review proof history | [Proof Requests --> View Past Proofs](https://optimates.ch/proof-requests/view-proof-requests) | This tab lists all previous proof presentation requests that have the state \`done\` or \`request-sent\` and records which credentials have been requested and whether they were active at the time the proof was presented. |
    ...
    The following is an example of the challenge:
    \`\`\`
        {
